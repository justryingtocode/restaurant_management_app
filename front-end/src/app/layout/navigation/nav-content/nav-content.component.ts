...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('navbarContent') navbarContent: ElementRef | undefined;
  @ViewChild('navbarWrapper') navbarWrapper: ElementRef | undefined;
  ...
  calcHeight(): string {
    // Example logic to calculate height dynamically
    const windowHeight = window.innerHeight;
    const navbarHeight = 70; // Assuming navbar height is 70px
